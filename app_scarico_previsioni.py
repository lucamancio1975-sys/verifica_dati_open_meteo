...
def load_local_csv(csv_filename):
    ...
    return pd.DataFrame(columns=[
        ...
        'anticipo_giorni', 'temp_media_8_20', 'rh_media_8_20', 'vpd_medio_8_20'
    ])
...
def process_station_forecast(stazione_nome, config, date_run_custom=None):
    ...
    4. Calcolo medie fascia diurna (08:00 - 20:00)
    """
    ...
    for g_target, anticipo in giorni_target:
        # Filtro: Data target e fascia oraria 08:00 - 20:00 (ore 8, 9, ..., 20)
        mask = (df_hourly['date'] == g_target) & (df_hourly['hour'] >= 8) & (df_hourly['hour'] <= 20)
        ...
        if not df_sub.empty:
            ...
            nuove_righe.append({
                ...
                'temp_media_8_20': t_mean,
                'rh_media_8_20': rh_mean,
                'vpd_medio_8_20': vpd_mean
            })
...
def main():
    ...
    <div class="header-card">
        ...
        <p>Database Previsioni 3 Stazioni (San Donato, Capalbio, Rispescia)<br>Medie Diurne 08:00 - 20:00 & Calcolo VPD</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.sidebar.info(
        ...
        f"**Fascia Oraria Diurna**: 08:00 - 20:00\n"
    ...
    st.markdown("""
    <div class="info-card">
        📲 <strong>Esecuzione Run Daily:</strong> Scarica le previsioni Open-Meteo (ICON-EU + ECMWF), elimina i dati del giorno corrente, estrae i 2 giorni successivi (ore 8:00-20:00) con il tag di anticipo (1d o 2d) e aggiorna i database CSV per ogni stazione.
    </div>
    """, unsafe_allow_html=True)
    ...
    if btn_run:
        with st.spinner("⏳ Connessione ad Open-Meteo, calcolo medie 8-20 e aggiornamento database CSV..."):
            esiti = {}
        ...
        if esiti:
            ...
            for st_nome, res in esiti.items():
                with st.expander(f"📍 Risultati Run: **{st_nome}**", expanded=True):
                    st.markdown("**Nuovi Dati Calcolati per la Run di Oggi (Fascia 8.00 - 20.00):**")
    ...
    with tab_charts:
        ...
        if df_db_graf.empty:
            ...
            # Grafico VPD Medio Stimato 8-20 per Data Previsione
            fig_vpd = px.line(
                df_db_graf,
                x="data_previsione",
                y="vpd_medio_8_20",
                ...
                markers=True,
                labels={"anticipo_giorni": "Anticipo (Giorni)", "vpd_medio_8_20": "VPD Medio 8-20 (kPa)", "data_previsione": "Data Prevista"},
                title=f"VPD Medio Diurno (8-20) - {st_graf} (1d vs 2d anticipo)"
            )
            ...
            with col_t:
                fig_t = px.bar(
                    ...
                    color="anticipo_giorni",
                    barmode="group",
                    labels={"temp_media_8_20": "Temp Media 8-20 (°C)"},
                    title=f"Temperatura Media Diurna (°C)"
                )
            ...
            with col_rh:
                fig_rh = px.bar(
                    ...
                    color="anticipo_giorni",
                    barmode="group",
                    labels={"rh_media_8_20": "RH Media 8-20 (%)"},
                    title=f"Umidità Relativa Media Diurna (%)"
                )
    ...
    with tab_info:
        ...
        In questo modo, ad ogni pressione del tasto **🚀 ESEGUI RUN PREVISIONI** da Smartphone, l'app scaricherà i nuovi dati Open-Meteo, calcolerà le medie 8:00 - 20:00 e committerà il CSV aggiornato direttamente nel tuo repository GitHub!
        """)
